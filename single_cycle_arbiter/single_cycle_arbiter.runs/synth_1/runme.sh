...
HD_PWD='C:/Users/abhis/single_cycle_arbiter/single_cycle_arbiter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log single_cycle_arbiter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source single_cycle_arbiter.tcl
